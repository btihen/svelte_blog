<div class="relative">
  <div class="mx-auto max-w-7xl">
    <div class="relative z-10 pt-14 lg:w-full lg:max-w-2xl">
      <svg
        class="absolute inset-y-0 right-8 hidden h-full w-80 translate-x-1/2 transform fill-yellow-50 dark:fill-gray-700 lg:block"
        viewBox="0 0 100 100"
      ...
      <div class="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
          ...
          >
            Exploring with Curriosity
          </h1>
          <p class="mt-6 text-lg leading-8 text-gray-600">
            Articles that explore various technologies and ideas.
          </p>
  ...
  <div class="bg-gray-50 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img
      ...
      src="/images/angelo-burgener-BqLvJnwobRY-unsplash.jpg"
      alt="Matterhorn"
    />
    <!--
    <img
